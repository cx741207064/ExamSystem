...
var Params = {
    ...
    getCookieDis: function (key) {
        var result = "";
        switch (key) {
            case "name": result = this.getCookie("E3CEEA3AC665C2E56FDD3DE4DABE4F6B"); break;
            case "pwd": result = this.getCookie("58C8B8B9C2BF978DA127AEFF8D86C33F"); break;
            case "vcode": result = this.getCookie("E53F3F7C85345A629E610268C66EABC4"); break;
            default:
    ...
    clrCookie: function () {
        Params.setCookie("E3CEEA3AC665C2E56FDD3DE4DABE4F6B", "", -1);
        Params.setCookie("58C8B8B9C2BF978DA127AEFF8D86C33F", "", -1);
    },
